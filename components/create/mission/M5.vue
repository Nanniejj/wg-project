        ...
        <v-col cols="12">
          ...
          />
            ...
            ></v-text-field> -->
                        ...
                        <v-row>
                            <v-col cols="12" sm="8" class="py-0">
                                ...
                                <v-select density="compact" variant="outlined" rounded="lg" :items="priority"
                                    v-model="selectedPriority" :style="{
                                        marginTop: '5px',
                                    }"></v-select>
                            </v-col>
                        ...
                        <v-text-field placeholder="รายละเอียด" v-model="newMessage" variant="outlined" rounded="lg"
                            clearable></v-text-field>

                        <span style="font-size: 16px">เลือกทีมปฏิบัติการ</span>
                        <v-combobox :items="team" v-model="selectedTeam" density="compact"
