      ...
      <v-row>
        ...
        <v-col cols="12" sm="12" md="3">
          <v-container
            :style="{
              ...
              backgroundColor: getMissionColor('M4'),
              borderRadius: '30px',
              marginTop: '20px',
              display: 'flex',
          ...
          >
            <span style="font-size: 100px; color: white">M4</span>
          </v-container>
        ...
        <v-col cols="12" class="pa-8 ma-0 d-none">
          <v-card class="mx-auto" rounded="xl" elevation="3" hover>
            <v-card-item>
              <v-col cols="12">
                <v-card-title> ผลปฏิบัติการ </v-card-title>
                <v-divider
                  :thickness="2"
                  inset
                  class="border-opacity-100 custom-divider"
              ...
              <span style="font-size: 16px">หน่วยงานรับผิดชอบ</span>
              <v-select
                multiple
                chips
                clearable
              ...
              <v-form v-model="valid">
                <v-container>
                  ...
                  <v-col cols="12">
                    <span style="font-size: 16px">ผลที่ได้จากการทำกิจกรรม</span>
                    <v-text-field
                      density="compact"
                      v-model="MainDescriptionMessage"
                      variant="outlined"
                  ...
                  <v-col cols="12">
                    <span style="font-size: 16px">ข้อเสนอ</span>
                    <v-text-field
                      density="compact"
                      v-model="MainDescriptionMessage"
                      variant="outlined"
...
<style scoped>
  .v-divider {
    height: 5000px; /* กำหนดความสูงที่ต้องการ */
}
