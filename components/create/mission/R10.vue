        ...
        <v-col cols="12" sm="12" md="3">
          <v-container
            :style="{
              ...
              backgroundColor: getMissionColor('R10'),
              borderRadius: '30px',
              marginTop: '20px',
              display: 'flex',
          ...
          >
            <span style="font-size: 100px; color: white">R10</span>
          </v-container>
              ...
              <v-form v-model="valid">
                <v-container>
                  ...
                  <v-row class="px-3">
                    ...
                    <v-col cols="12" md="6">
                      <span style="font-size: 16px">รูปแบบ</span>
                      <v-select
                        density="compact"
