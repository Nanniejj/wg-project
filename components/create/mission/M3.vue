    ...
    <v-col cols="12">
      <v-row>
        ...
        <v-col cols="5" class="pa-8 ma-0">
          ...
          >
            <v-card-item>
              <v-card-title> สร้างแผนงาน </v-card-title>

              <span style="font-size: 16px">ชื่อแผนงาน</span>
              <v-text-field
                label="ชื่อแผนงาน"
                v-model="NameMessage"
                variant="outlined"
        ...
        <v-col cols="12" md="7" class="pa-8 ma-0">
          <!-- <v-divider
                :thickness="2"
                inset
                class="pt-8 border-opacity-100 custom-divider"
                style="border-style: dashed; color: #707070"
              ></v-divider> -->
          <v-card
            class="mx-auto pa-2"
          ...
          >
            ...
            <v-card-item>
              <span style="font-size: 16px">จำนวนเพจเป้าหมาย</span>
              <v-text-field
