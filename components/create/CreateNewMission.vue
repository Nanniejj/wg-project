<template>
    <v-row>
        ...
        <v-col 
            cols="4" class="py-0"
            style="border-right: 2px solid #2A3547;"
        >
            <v-card flat>
                <v-card-title>
                ...
                <v-card-text class="scrollable-body">
                    <v-row no-gutters>
                        <v-col 
                            cols="6"
                            v-for="widget in widgets" :key="'widget- ' + widget.id ">
                            <v-hover>
                                <template v-slot:default="{ isHovering, props }">
                                    <v-card  
                                        class="h-100"
                                        @click="handleSelectedWidget(widget.id)"
                                        flat
                                        v-bind="props"
                ...
                <v-card-text class="scrollable-body">
                    <v-row>
                        ...
                        <v-col cols="12">
                            ...
                            <v-textarea
                                v-model="createMission.description"
                            ...
                            >
                                <template v-slot:selection="{ item, index }">
                                    <v-chip
                                        ...
                                        :text="`Team ${item.title}`"
                                        :model-value="item.raw._id"
                                        size="small"
                                        variant="flat"
                                        closable
                                        @click:close="removeSelection(createMission.teams,index)"
                                    ></v-chip>
                                </template>
                            </v-combobox>
                        </v-col>
                    ...
                    <v-row>
                        ...
                        <v-col v-if="selectedWidgets.length === 0" cols="12" class="py-8 border-md border-dashed text-center">
                        ...
                        <v-col v-else cols="12">
                            ...
                            <WidgetsShowCase 
                                ...
                                @updateWidgetList="updateWidgets"
                            />
                        </v-col>
                    </v-row>
                </v-card-text>
...
<style scoped>
.scrollable-body {
    max-height: 70vh; /* หรือปรับเป็น 60vh, 70vh */
    overflow-y: auto;
}
