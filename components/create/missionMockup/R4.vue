  ...
  <v-row>
    ...
    <v-col cols="12">
      ...
      <v-row>
        <!-- <v-col
          ...
          <v-container
            :style="{
              ...
              backgroundColor: getMissionColor('R4'),
              borderRadius: '30px',
              marginTop: '20px',
              display: 'flex',
          ...
          >
            <span style="font-size: 100px; color: white">R4</span>
          </v-container>
        ...
        <v-col cols="12" class="pt-8 d-none">
          <span class="px-4" style="font-size: 30px">มิติ</span>
          <v-divider
            :thickness="2"
            inset
            class="border-opacity-100 custom-divider"
        ...
        <v-col cols="12" class="pa-10 ma-0 d-none">
          <v-card class="mx-auto pa-2" rounded="xl" elevation="3" hover>
            <v-card-item>
              <span style="font-size: 16px">มิติ</span>
              <v-select
                density="compact"
                variant="outlined"
                rounded="lg"
...
<script setup>
  ...
  const dimension = ref([
    "มิติผู้มีอธิพลทางความคิด (Influencer)",
    "มิติข้อมูลข่าวสาร (เพจหน่วยประชาสัมพันธ์)",
